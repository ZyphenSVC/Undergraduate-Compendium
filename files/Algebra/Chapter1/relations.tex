...
This is called the induction hypothesis.In proof writing, if we are given an ``If\ldots Then\ldots'' statement, we generally assume that the statement before the ``Then'' is true, and attempt to prove the rest.
This is the same thing we have proved through induction.
It can be seen as a result of continued direct proofs compiled together and generalized to become the induction we know today.The following example is how we use induction in today's world, and it is important to note how we use it compared to how one may have done it for a proofs course.
