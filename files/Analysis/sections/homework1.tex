...
\begin{problem}[Greatest Lower Bound Property of $\r$]{
    Deduce the g.l.b.\ property from the l.u.b.\ property.
    Let $S\subset\r$ and suppose $S$ is bounded below.
    Show that
    \[
        \inf(S)=-\sup\{-x:x\in S\}.
    \]
    ...
    By the l.u.b.\ property of $\r$, there exists
    \[
