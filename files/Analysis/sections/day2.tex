...
\begin{remark}
	Field $\rr$ is complete, which means it has the least upper bound (l.u.b) property.
\end{remark}

\begin{definition}[l.u.b Property]
	If $S\subset\rr$ and $S$ is bounded above, i.e.\ there is a $C\in\rr$ such that $C\geq x$ for all $x\in S$, then there is some $\alpha\in\rr$ which is the least upper bound for $S$.
...
\begin{corollary}
{The Archimedian Property of $\rr$ states:
    \begin{displayquote}
        For any $x\in\rr$, there exists $n\in\n$ such that $n > x$.
    \end{displayquote}}
...
\begin{remark}
	...
	\begin{displayquote}
		If $x\in\rr$, then there exists $n\in\n$ such that $n>x$.
	\end{displayquote}
...
\begin{lemma}[Ordering of Squares]{
	$a,b\in\rr$, $a,b > 0$, $a < b$ if and only if $a^2 < b^2$.
}
	Prove this as an Exercise.
\end{lemma}
...
\begin{corollary}{
	...
	Define $S \coloneqq \{y\in\rr : y^2 < 2\}$.
