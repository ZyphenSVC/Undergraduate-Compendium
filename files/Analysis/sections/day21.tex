...
\begin{definition}[$\eps$-Neighbourhood]
    Let $\eps > 0$.
    The neighborhood of $x\in\rr$ is:
    \[
...
\begin{definition}[Open Set]
    A set $U\subset\rr$ is open if for every $x\in U$, there exists $\eps > 0$ such that $\vee_{\eps}(x)\subset U$.
\end{definition}
...
\begin{definition}[Limit Point]
    Let $E\subset\rr$.
    A point $x_0\in\rr$ is a limit point of $E$ if for every $\eps > 0$,
    \[
...
\begin{definition}[Isolated Point]
    Given $E\subset\rr$, $x_0\in E$ is an isolated point if it is not a limit point.
\end{definition}

\begin{proposition}{
    Given $E\subset\rr$, $x_0\in\rr$ is a limit point of $E$ if and only if there exists a sequence $(x_n)$ in $E\setminus\{x_0\}$ such that $x_n\to x_0$.
}
...
\begin{definition}[Closed]
    $E\subset\rr$ is closed if it contains all its limit points.
\end{definition}
