...
\begin{lemma}{
    Suppose $S\subseteq\rr$ is nonempty, closed, and bounded.
...
\end{lemma}
\begin{theorem}{
    Let $[a,b]\subset\rr$ and suppose $f:[a,b]\to\rr$ is continuous.
...
\begin{theorem}[Intermediate Value Theorem]{
    Let $X$ be connected and $f:X\to\rr$ continuous.
...
\begin{theorem}{
    Let $C\subseteq\rr$ be compact.
    Suppose $f:C\to\rr$ is continuous.
