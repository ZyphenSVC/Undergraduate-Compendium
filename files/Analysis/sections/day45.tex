...
\begin{example}[$\ell^p$-metric]
    For $x,y\in\r^n$ and $1\leq p<\infty$, define
    \[
...
\begin{example}[$L^p$-metric]
    For functions $f,g:[0,1]\to\r$ and $1\leq p<\infty$, define
    \[
...
\begin{definition}[Sets of Continuous Functions]
    \begin{gather*}
        C^0([a,b]) \coloneqq \{\text{continuous functions } [a,b]\to\r\}.\\
        C^k([a,b]) \coloneqq \{\text{$k$-times continuously differentiable functions } [a,b]\to\r\}.\\
    \end{gather*}
\end{definition}

\begin{definition}[Smooth Functions]
    \[
        C^\infty([a,b]) \coloneqq \{\text{infinitely differentiable functions } [a,b]\to\r\}.
    \]
\end{definition}
