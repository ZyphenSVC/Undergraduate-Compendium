...
\begin{definition}[Sequence]
    A sequence on $\r$ is a function $\n\to\r$.
\end{definition}

\begin{definition}[Sequence Convergence]
    A sequence $(x_n)$ converges to $L\in\r$ if for every $\epsilon >0$ there exists $N\in\n$ such that for all $n > N$,
    \[
        \abs{x_n - L} < \epsilon.
    \]
\end{definition}
...
\begin{definition}[Bounded]
    $(x_n)$ is bounded if there exists $C\in\r$ such that $\abs{x_n}\leq C$ for all $n\in\n$.
\end{definition}
