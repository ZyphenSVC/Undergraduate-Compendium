...
\begin{theorem}{
    ...
    We want to show that for every $x_0\in\r$, both $f(x_0^-)$ and $f(x_0^+)$ exist, and
    \[
    ...
    \textbf{(2).}
    Let $J\subset\r$ be the set of discontinuities of $f$.
...
\begin{theorem}{
    If $f:\r\to\r$ is any function, then the set of removable and jump discontinuities is countable.
}
    For $\alpha > 0$, define
    \[
        D_\alpha \coloneqq \left\{x\in\r :
                               \begin{array}{l}
