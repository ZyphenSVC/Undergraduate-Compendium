...
\begin{theorem}[Intermediate Value Theorem]{
	Let $X$ be connected and $f:X\to\rr$ be continuous.
...
\begin{definition}[Directional Derivative]
	Given $U\subset\rr^n$ open, $f:U\to\rr^m$, $a\in U$, and $u\in\rr^n$, define
	\[
...
\begin{definition}[Differentiability]
	Given $U\subset\rr^n$ open and $a\in U$, a function $f:U\to\rr^m$ is differentiable at $a$ if there exists a linear map $B:\rr^n\to\rr^m$ such that
	\[
		\frac{f(a+h) - f(a) - Bh}{\norm{h}}\to 0
		\qquad\text{as } h\to 0.
	\]
...
\begin{theorem}{
	If $f$ is differentiable at $a$, then for every $u\in\rr^n$, the directional derivative $D_u f(a)$ exists and
	\[
		D_u f(a) = Bu.
	\]
}
